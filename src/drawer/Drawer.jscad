// [COPIED VERSION OF FILE] 
// Source: ../3dDrawer/coreDrawer.jscad
/*
...
Drawer.makeComponent = function(componentSpec, params) {
	...
	component = component.translate([ componentSpec.centreX,
			componentSpec.centreY, componentSpec.centreZ ]);
	return component
};
...
function checkParamsAreValid(params) {
	if (params.printerMinRes < 0)
		throw "Printer resolution must be positive"
};
