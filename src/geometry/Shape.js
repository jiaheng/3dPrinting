...
function Shape() {
	...
	return {
		...
		getDistanceToRightBoundary : function() {
			throw new Error(
					"getDistanceToRightBoundary() not implemented in Shape "
							+ "base class")
		},

		getDistanceToLeftBoundary : function() {
			throw new Error(
					"getDistanceToLeftBoundary() not implemented in Shape "
							+ "base class")
		},

		getDistanceToBackBoundary : function() {
			throw new Error(
					"getDistanceToBackBoundary() not implemented in Shape "
							+ "base class")
		},

		getDistanceToFrontBoundary : function() {
			throw new Error(
					"getDistanceToFrontBoundary() not implemented in Shape "
							+ "base class")
		},
		...
		isAdjacentTo : function(otherShape) {
			...
			return this
					.isAdjacentOnAxis(otherShape, 'X', xAxisBoundaryDistance)
					|| this.isAdjacentOnAxis(otherShape, 'Y',
							yAxisBoundaryDistance)
		...
		isAdjacentOnAxis : function(otherShape, axis, distanceToBoundaries) {
			...
			var adjacentOnAxis = Utilities.approximatelyEqual(distanceBetween,
					distanceToBoundaries, 0.001)
