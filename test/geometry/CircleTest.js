...
var CircleSpecification = require('../../src/interface/CircleSpecification.js').CircleSpecification
var CircleSpecificationTest = require('../interface/CircleSpecificationTest.js')
var ShapeTest = require('./ShapeTest.js')
...
describe('Circle', function() {
	...
	describe('#getDiameter', function() {
		...
		it('should be twice the radius', function() {
			circle.getDiameter().should.equal(2 * radius)
		})
	})
