...
var Specification = require('../../src/interface/Specification.js').Specification
...
function shouldBehaveLikeSpecification(specification) {
	describe('Anything inheriting from Specification', function() {
		...
		describe('#addSpecification', function() {
			...
			it('should have the same properties as the added Specification',
					function() {
						specification.should.have.property(
								'secondTestProperty', 'second')
					})

			it('should still have its original properties', function() {
				specification.should.have
						.property('firstTestProperty', 'first')
			})

			describe(
					'when the added Specification has the same property as the '
							+ 'original property but with a different value',
					function() {
						beforeEach(function() {
						...
						it('should use the added Specification\'s value',
								function() {
									specification.firstTestProperty.should
											.equal('different')
								})
					})
		})
