...
var Component = require('../../src/component/Component.js').Component 
var Circle = require('../../src/geometry/Circle.js').Circle
var PlaceableComponent = require('../../src/component/PlaceableComponent.js').PlaceableComponent
var ComponentTest = require('./ComponentTest.js')
var ShapeTest = require('../geometry/ShapeTest.js')
	...
	describe('Anything inheriting from PlaceableComponent', function() {
			...
			describe('the first Placeable', function() {
				...
				describe('#getAdjacentComponents', function() {
					it('should return an array containing the second Placeable', function() {
						firstPlaceable.getAdjacentComponents().should.containEql(secondPlaceable)
					})
				})
			})
			...
			describe('the second Placeable', function() {
				describe('#getAdjacentComponents', function() {
					it('should return an array containing the first Placeable', function() {
						secondPlaceable.getAdjacentComponents().should.containEql(firstPlaceable)
					})
				})
			})
		}
		...
		describe('#addAdjacentComponent', function() {
			...
			it('should add a new PlaceableComponent to the adjacent components Array', function() {
				placeable.getAdjacentComponents().should.containEql(otherPlaceable)
			})
		})
	})
}
