...
var ComponentSpecification = require('../../src/interface/ComponentSpecification.js').ComponentSpecification
var Point = require('../../src/geometry/Point.js').Point
var Circle = require('../../src/geometry/Circle.js').Circle
var ComponentSpecificationTest = require('../interface/ComponentSpecificationTest.js')
	...
	describe('Anything inheriting from Component', function() {
		...
		describe('the returned string', function() {
			...
			it('should contain the id', function() {
				string.should.containEql('ID: ' + id)
			})
			
			it('should contain the centre point', function() {
				string.should.containEql('Centre point: (' + centreX + ', ' + centreY + ', ' + centreZ + ')')
			})
		})		
	})
