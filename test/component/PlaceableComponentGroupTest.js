...
var PlaceableComponentGroup = require('../../src/component/PlaceableComponentGroup.js').PlaceableComponentGroup
var PlaceableComponent = require('../../src/component/PlaceableComponent.js').PlaceableComponent
Circle = require('../../src/geometry/Circle.js').Circle
	...
	describe('Anything inheriting from PlaceableComponentGroup', function() {
		...
		describe('#addComponent', function() {
			...
			it('should contain the Components that were added', function() {
				group.addComponent(component)
				group.getComponents().should.containEql(component)
			})
		})
	}) 
}